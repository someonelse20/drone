...
soft, hard = calibrate_mag.alignment_calibration(["mx+", "my+", "mz+"], ["m1", "m2", "mx+", "mx-", "my+", "my-", "mz+", "mz-"])
...
xpoints = calibrate(read_file("mx+"), soft, hard)
ypoints = calibrate(read_file("my+"), soft, hard)
zpoints = calibrate(read_file("mz+"), soft, hard)
